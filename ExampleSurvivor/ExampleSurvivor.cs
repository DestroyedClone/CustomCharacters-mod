...
namespace ExampleSurvivor
{
    ...
    [BepInPlugin(MODUID, "MedicSurvivor", "1.0.0")] // put your own name and version here
    ...
    {
        public const string MODUID = "com.DestroyedClone.MedicSurvivor"; // put your own names here
        ...
        internal static void CreatePrefab()
        {
            ...
            GameObject model = characterPrefab;
            ...
            bodyComponent.baseRegen = 2f;
            bodyComponent.levelRegen = 0.35f;
            ...
            //rtBoxGroup hurtBoxGroup = model.AddComponent<HurtBoxGroup>();

            /*rtBox componentInChildren = model.GetComponentInChildren<CapsuleCollider>().gameObject.AddComponent<HurtBox>();
        ...
        private void RegisterCharacter()
        {
            ...
            string desc = "Medic is a class for healing your allies.<color=#CCD3E0>" + Environment.NewLine + Environment.NewLine;
            desc = desc + "< ! > Heal allies using your medigun." + Environment.NewLine + Environment.NewLine;
            desc = desc + "< ! > Fill your ÜberCharge by healing teammates.." + Environment.NewLine + Environment.NewLine;
            desc = desc + "< ! > Each medigun fills a different role, discover what works best for you!." + Environment.NewLine + Environment.NewLine;
            desc = desc + "< ! > Activating your ubercharge allows you to apply a short duration buff to you and your target. Pop it, don't drop it!</color>" + Environment.NewLine + Environment.NewLine;

            // add the language tokens
            LanguageAPI.Add("EXAMPLESURVIVOR_NAME", "Teufort Medic");
        ...
        void PassiveSetup()
        {
            ...
            LanguageAPI.Add("EXAMPLESURVIVOR_PASSIVE_NAME", "Man of Medicine");
            LanguageAPI.Add("EXAMPLESURVIVOR_PASSIVE_DESCRIPTION", "Able to <style=cIsHealing>heal allies</style>. Increased base health regen.");
        ...
        void PrimarySetup()
        {
            ...
            LanguageAPI.Add("EXAMPLESURVIVOR_PRIMARY_CROSSBOW_NAME", "Crusader's Crossbow");
            LanguageAPI.Add("EXAMPLESURVIVOR_PRIMARY_CROSSBOW_DESCRIPTION", "Fires a syringe that <style=cIsHealing>heals teammates</style> and <style=cIsDamage>hurts enemies</style> based on reverse falloff. Deals up to <style=cIsDamage>300% damage</style>.");
            ...
            LanguageAPI.Add("EXAMPLESURVIVOR_PRIMARY_SYRINGEGUN_NAME", "Syringe Gun");
            LanguageAPI.Add("EXAMPLESURVIVOR_PRIMARY_SYRINGEGUN_DESCRIPTION", "Fires syringes for <style=cIsDamage>10% damage</style>.");

            SkillDef mySkillDef2 = ScriptableObject.CreateInstance<SkillDef>();
            mySkillDef2.activationState = new SerializableEntityStateType(typeof(MedicSyringeGun));
            ...
            mySkillDef2.icon = Assets.icon1;
            mySkillDef2.skillDescriptionToken = "EXAMPLESURVIVOR_PRIMARY_SYRINGEGUN_DESCRIPTION";
            mySkillDef2.skillName = "EXAMPLESURVIVOR_PRIMARY_SYRINGEGUN_NAME";
            mySkillDef2.skillNameToken = "EXAMPLESURVIVOR_PRIMARY_SYRINGEGUN_NAME";
            ...
            SkillFamily skillFamilyPrimary = component.primary.skillFamily;
...
namespace EntityStates.ExampleSurvivorStates
{
    ...
    //public class MedicSyringeGun : Treebot.Weapon.FireSyringe
    public class MedicSyringeGun : BaseSkillState, IOnDamageInflictedServerReceiver
    {
        ...
        private void FireArrow()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    float bonusYaw = (float)Mathf.FloorToInt(totalYawSpread);
                    Vector3 forward = Util.ApplySpread(aimRay.direction, 0f, 0f, 1f, 1f, bonusYaw, 0f);
                    ProjectileManager.instance.FireProjectile(ExampleSurvivor.ExampleSurvivor.arrowProjectile, aimRay.origin, Util.QuaternionSafeLookRotation(forward), base.gameObject, this.damageCoefficient * this.damageStat, 0f, Util.CheckRoll(this.critStat, base.characterBody.master), DamageColorIndex.Default, null, -1f);
                }
            }
        }
